...
<head>
    ...
    <style>
        ...
        .sidebar a { color: #adb5bd; text-decoration: none; padding: 15px 20px; display: block; }
...
<div class="sidebar d-flex flex-column p-3">
    ...
    <ul class="list-unstyled mt-3">
        <li>
            <a href="<?= $base_path ?>index.php" class="<?= basename($_SERVER['PHP_SELF'])=='index.php'?'active':'' ?>">
                <i class='bx bxs-dashboard'></i> Tổng quan
            </a>
        </li>
        
        <li>
            <a href="<?= $base_path ?>usermanager/members.php" class="<?= (strpos($_SERVER['PHP_SELF'], 'usermanager') !== false) ? 'active' : '' ?>">
                <i class='bx bxs-user-detail'></i> Quản lý Thành viên
            </a>
        </li>

        <li><a href="<?= $base_path ?>posts.php"><i class='bx bxs-edit'></i> Quản lý Bài viết</a></li>
        <li><a href="<?= $base_path ?>topics.php"><i class='bx bxs-category'></i> Quản lý Chủ đề</a></li>
