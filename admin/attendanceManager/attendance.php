                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div><i class='bx bx-calendar'></i> <?= date('d/m/Y H:i', strtotime($row['ngay_bat_dau'])) ?>
                                </div>
                            ...
                            <td class="text-center">
                                <a href="take_attendance.php?id=<?= $row['ma_hoat_dong'] ?>" class="btn btn-primary btn-sm"
                                    title="Ghi danh thành viên">
                                    <i class='bx bx-user-check'></i> Ghi danh
                                </a>
                                <a href="export_word.php?id=<?= $row['ma_hoat_dong'] ?>" class="btn btn-success btn-sm"
