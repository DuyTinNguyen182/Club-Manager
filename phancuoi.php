  ...
  <div class="footer-content">
    ...
    <div class="footer-col footer-links">
      ...
      <ul>
        ...
        <li><a href="contact.php"><i class="fa-solid fa-chevron-right" style="font-size:0.7em"></i> Liên hệ góp ý</a>
        </li>
        <li><a href="signup.php"><i class="fa-solid fa-chevron-right" style="font-size:0.7em"></i> Đăng ký thành
            viên</a></li>
      </ul>
    </div>
